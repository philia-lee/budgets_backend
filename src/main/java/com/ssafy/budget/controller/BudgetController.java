...
public class BudgetController {
    ...
    public ResponseEntity<String> deleteBudget(@Parameter(hidden = true) @UserId Long userId,
    ...
    public ResponseEntity<String> updateBudget(@Parameter(hidden = true) @UserId Long userId,
    ...
    public ResponseEntity<List<Budget>> getBudgets(@Parameter(hidden = true) @UserId Long userId) {
